<template>
  <div class="main">
    <BScroll :height="height" :data="djRadios">
      <div class="van">
...
import { getTodayPrefer, getDjRecommend } from "../../network/index";
import singsheet from "../../components/singsheet/index.vue";
import { DjRadios, DjRecommend } from "@/network/djRecommend";
import { Data } from "@/network/Prefer";
...
export default {
  ...
  setup() {
    const data = reactive({
      banners: [] as string[],
      djRadios: [] as DjRadios[],
      perfered: [] as Data[],
      height: "",
    });
    data.height = window.innerHeight / 10 - 8.8 + "rem";
    getDjRecommend((res) => {
      data.djRadios = res.djRadios.slice(0, 9);
    });
    getTodayPrefer((res) => {
      data.perfered = res.data;
    });
    const methods = {
      tocompetitive() {},
      toradiorate() {},
    ...
    data.banners = ["http://p1.music.126.net/E34ymodO55ENFjYoXsQycg==/109951164624218713.jpg", "http://p1.music.126.net/sFH0bmEmGfabKRtOt7PZsg==/109951164623812537.jpg", "http://p1.music.126.net/RJYfuwyifdNDupGH8MR4YA==/109951164624421533.jpg", "http://p1.music.126.net/lrgQjU7jKxyHccVDCSsaUg==/109951164623870101.jpg"];
    return {
      ...toRefs(data),
      ...methods,
    };
